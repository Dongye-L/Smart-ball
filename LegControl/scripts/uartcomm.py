"""
UARTTable: read newline-delimited JSON packets from a (virtual) serial port.

Packet format (matches the Arduino MPU6050 firmware):
    {"key": "/UpperLeg", "value": [w, x, y, z]}\n
    {"key": "/LowerLeg", "value": [w, x, y, z]}\n

Blender-side scripts import this from the "scripts" folder next to the
.blend file. A copy lives here so the LegControl folder is self-contained.
"""
import sys
import json
import logging
